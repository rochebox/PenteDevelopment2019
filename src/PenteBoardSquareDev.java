...
public class PenteBoardSquareDev {
    //data
    ...
    //constructor
    public PenteBoardSquareDev(int x, int y, int w, int h) {
        ...
        //bColor = Color.YELLOW;
        sState = PenteGameBoardDev.EMPTY;
    ...
    public void drawMe(Graphics g) {
        ...
        // NEW STEP 3  SHADOW
        if(sState != PenteGameBoardDev.EMPTY) {
        ...
        //
        if(sState == PenteGameBoardDev.BLACKSTONE) {
        ...
        if(sState == PenteGameBoardDev.WHITESTONE) {
